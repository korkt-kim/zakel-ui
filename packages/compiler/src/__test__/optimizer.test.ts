...
import { componentList } from "@zakel-ui/core/components/componentList";

describe("optimizer", () => {
  it("should compile Kuma components to raw HTML when no dynamic props are given", () => {
    // Arrange
    const code = `
        import { Box, Text } from "@zakel-ui/core";
  ...
  it("should not compile Kuma components with dynamic props to raw HTML", () => {
    // Arrange
    const code = `
      import { Box, Text, HStack } from "@zakel-ui/core";
  ...
  it("should compile SelfClosingTags with static styles to raw HTML", () => {
    // Arrange
    const code = `
      import { Image } from "@zakel-ui/core";
