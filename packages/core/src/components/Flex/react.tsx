...
/**
 * Flex is a Box component with 'display: flex' by default. It's used to create flexible layouts in a Zakel UI application.
 * Like Box, it can accept any system style properties for extensive customization.
 *
 * @see — http://zakel-ui.com/docs/Components/Flex
 */
