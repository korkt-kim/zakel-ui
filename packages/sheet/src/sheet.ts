...
// to avoid cyclic dependency, we declare an exact same type declared in @zakel-ui/system
 ...
 * styles, and pseudo-classes used by zakel-ui. It provides methods to add and retrieve
