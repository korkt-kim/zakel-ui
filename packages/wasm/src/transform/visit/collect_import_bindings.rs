...
impl<'a> Visit<'a> for CollectImportBindings<'a, '_> {
    fn visit_import_declaration(&mut self, decl: &ImportDeclaration<'a>) {
        if decl.source.value == "@zakel-ui/core" {
...
mod test {
    ...
    fn test_ensure_react_import() {
        ...
        let source_text =
            "import { Button,  Box as ZakelBox } from '@zakel-ui/core'; import { css } from '@zakel-ui/core'"
                .to_string();
        ...
        assert_eq!(imports.get("Box"), Some(&"ZakelBox".to_string()));
