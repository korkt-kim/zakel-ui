...
import ZakelUIWebpackPlugin, { CSS_PATH } from "./plugin";
...
const emptyCssExtractionFile = _require.resolve("../assets/zakel.css");

type Options = {
  config?: string;
  plugin: ZakelUIWebpackPlugin;
  outputDir?: string;
  wasm?: boolean;
};

const zakelUiLoader: RawLoaderDefinitionFunction<Options> = function (
  source: Buffer,
) {
