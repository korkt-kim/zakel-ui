...
mod tests {
    ...
    fn test_transform_sync() {
        ...
        assert_eq!(
            source_text,
            "import __ZAKEL_REACT__ from 'react';import { k, Box } from '@zakel-ui/core';export const App = () => {return <Box as='div' IS_ZAKEL_DEFAULT={true}><Box as='span' IS_ZAKEL_DEFAULT={true}>hello</Box></Box>;};"
        );
    }
}
